...
The dataframe credit_clean, from which the nzv  has been removed, is the final dataset to use for modeling approach.
...
```{r model_rf, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
